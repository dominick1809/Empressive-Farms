...
public class Employee_Screen
{
    ...
    private class addNewProducts extends JFrame{ 
        ...
        public addNewProducts(){
            ...
            thisframe.setBounds(300, 70, 800, 600); //set its position, width and height // x-axix, y-axix, width, height

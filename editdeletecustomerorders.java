...
public class editdeletecustomerorders 
{
    public JFrame frame;
	...
	public static void main(String[] args) 
	{
		EventQueue.invokeLater(new Runnable() 
		{
			...
			{
				try {
					editdeletecustomerorders window = new editdeletecustomerorders();
	 ...
	 */
	public editdeletecustomerorders() 
	{
		initialize();
